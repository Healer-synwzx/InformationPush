...
//替换你的ACCESS_TOKEN
$ACCESS_TOKEN = json_decode(https_request("https://qyapi.weixin.qq.com/cgi-bin/gettoken?corpid=企业ID&corpsecret=应用密钥"),true)["access_token"];
//模板消息请求URL
...
//$MsgArray["url"]="http://ts.healer520.top/msg.php?title=".$MsgArray["title"]."&time=".$MsgArray["time"]."&msg=".$MsgArray["msg"];
//转化成json数组让微信可以接收
